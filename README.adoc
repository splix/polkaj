...
- `io.emeraldpay.polkaj:polkaj-client:{lib-version-dev}` - RPC base classes
- `io.emeraldpay.polkaj:polkaj-client-rpc:{lib-version-dev}` - JSON RPC HTTP client
- `io.emeraldpay.polkaj:polkaj-client-ws:{lib-version-dev}` - JSON RPC WebSocket client
